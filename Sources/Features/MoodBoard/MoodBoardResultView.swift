...
struct MoodBoardResultView: View {
    ...
    private var actionsSection: some View {
        VStack(spacing: EcrinSpacing.md) {
            // "Essayer ces bijoux" — sets pendingMoodBoardJewelry in AppState then dismisses.
            // MoodBoardGalleryView observes the change and opens ARTryOnWrapperView.
            // Disabled when the board has no jewelry items (should not normally happen).
